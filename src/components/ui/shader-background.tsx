...
// Vertex shader — positions a full-screen quad
const vsSource = `
...
// Fragment shader — animated plasma line art on a deep purple gradient
const fsSource = `
...
const ShaderBackground: React.FC = () => {
  ...
  return (
    <div className="shader-bg-wrapper" aria-hidden="true">
      <canvas
        ref={canvasRef}
